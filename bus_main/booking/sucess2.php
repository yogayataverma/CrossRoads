...
<body>
<div class=" sticky-top " style="margin-top:-10px;"><?php include("../navbar/navbar22.html"); ?></div>
<form method="POST" action="download12.php">
<div>
...
<div>
  <label class="form-label" style="width:500px;margin-left:450px;" >Ticket No</label>
  <input type="text" style="width:500px;margin-left:450px;" name="ticket12" class="form-control" placeholder="Enter Ticket no">
</div>
<div>
