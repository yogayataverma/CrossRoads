...
<?php include("C:/xampp1/htdocs/web1/bus_main/navbar/navbar22.html"); ?>
...
<form class="form-group" style="display:flex;margin-top:50px;" method="POST" action="../main/main2.php">
